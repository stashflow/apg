...
const topics = [
  ...
  { number: 6, title: 'dbq, leq & saq practice', description: 'DBQ document strategies, LEQ thesis writing, SAQ precision, scoring rubrics, and model high-score responses.' },
]
