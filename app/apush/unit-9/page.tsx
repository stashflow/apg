...
const topics = [
  ...
  { number: 3, title: '9/11 & war on terror', description: 'September 11, PATRIOT Act, invasion of Afghanistan, Iraq War, and the civil liberties debate.' },
  { number: 4, title: 'modern political polarization', description: 'culture wars, partisan media, Obama\'s election, Tea Party, and the intensification of ideological divisions.' },
  { number: 5, title: 'supreme court landmark cases', description: 'Marbury, McCulloch, Dred Scott, Plessy, Brown, Miranda, Roe, Bush v. Gore, Obergefell — all you need to know.' },
  { number: 6, title: 'dbq, leq & saq practice', description: 'DBQ document strategies, LEQ thesis writing, SAQ precision, scoring rubrics, and model high-score responses.', videoId: '3JVrLMpzBIQ' },
]
